...
namespace GateWise.Infrastructure.Migrations
{
    ...
    [Migration("20260610001904_AddOrganizationInviteSpaces")]
    partial class AddOrganizationInviteSpaces
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GateWise.Core.Entities.OrganizationInvite", b =>
                {
                    ...
                    b.Property<DateTime?>("MemberExpiresAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("member_expires_at");

                    b.Property<DateTime?>("MemberStartsAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("member_starts_at");
            ...
            modelBuilder.Entity("GateWise.Core.Entities.OrganizationInviteSpace", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_organization_invite_spaces");

                    b.HasIndex("InviteId")
                        .HasDatabaseName("ix_organization_invite_spaces_invite_id");

                    b.HasIndex("SpaceId")
                        .HasDatabaseName("ix_organization_invite_spaces_space_id");

                    b.ToTable("organization_invite_spaces", (string)null);
                });
            ...
            modelBuilder.Entity("GateWise.Core.Entities.OrganizationInviteSpace", b =>
                {
                    b.HasOne("GateWise.Core.Entities.OrganizationInvite", "Invite")
                        .WithMany("InviteSpaces")
                        .HasForeignKey("InviteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_organization_invite_spaces_organization_invites_invite_id");
                    ...
                    b.HasOne("GateWise.Core.Entities.Space", "Space")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_organization_invite_spaces_spaces_space_id");
